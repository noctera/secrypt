...
namespace ui {
  ...
  int ImguiFrame::createWindow(int width, int height, const char* name) {
  ...
  void ImguiFrame::renderWindow(void (*func)()) {
    // Our state
  ...
  void ImguiFrame::glfw_error_callback(int error, const char* description) {
